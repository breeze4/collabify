...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playlistJsx = __webpack_require__(157);

	var _playlistJsx2 = _interopRequireDefault(_playlistJsx);

	var CollabifyApplication = (function (_React$Component) {
	    _inherits(CollabifyApplication, _React$Component);

	    function CollabifyApplication() {
	        _classCallCheck(this, CollabifyApplication);

	        _get(Object.getPrototypeOf(CollabifyApplication.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(CollabifyApplication, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(_playlistJsx2['default'], { message: 'hi from app' });
	        }
	    }]);

	    return CollabifyApplication;
	})(_react2['default'].Component);

	exports['default'] = CollabifyApplication;

	_react2['default'].render(_react2['default'].createElement(CollabifyApplication, null), document.getElementById('container'));
